...
if __name__ == "__main__":
    ...
    merge_df.index += 1
    my_filters = ("客戶代號 == 'CAS90014' and 確認碼 == 'Y' and 結案碼 =='N' and 結帳單別 in ['612', '615']")
    # my_filters = ("確認碼 == 'Y' and 結案碼 =='N' and 結帳單別 in ['612', '615']")
    ...
    output_df.insert(len(output_df.columns), "憑證號碼",
                     ['-'.join(i) for i in zip(merge_df['憑證單別'], merge_df['憑證單號'], merge_df['憑證序號'])])
