class DannyReport:
    ...
    def __init__(self):
        ...
        from config import db_cfg, opr_cfg, mysql_url
        ...
        # if merge_df['結帳單別'].str.strip() == '612':
        #     output_df.insert(5, "發票號碼", merge_df['發票號碼(訖)'])
        # if merge_df['結帳單別'].str.strip() in ('611', '619'):
        #     output_df.insert(5, "發票號碼", merge_df['INVOICE_NO'])
        ...
        output_df = output_df.drop_duplicates("憑證號碼")
        ...
        tableName = "report"
        COMMON.df_to_mysql(output_df, mysql_url, tableName)
